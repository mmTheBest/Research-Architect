...
A successful run leaves a transparent research trail under `paper_output/`, including the research spine, source inventory, literature map, study design, evidence bank, claim register, writing rationale matrix, draft, and audit report.

## Safety boundary

External papers are used to learn structure, problem framing, rhetoric, and evidence expectations. User-provided evidence remains authoritative for the user's paper.
